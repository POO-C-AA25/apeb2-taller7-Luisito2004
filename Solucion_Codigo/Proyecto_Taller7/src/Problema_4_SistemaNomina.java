...
class Comisionista extends Trabajador{
    ...
    public double calcularSueldo(){
        return this.sueldo = this.totalVentas * (porcentaje / 100.0);
    }
...
class PorHora extends Trabajador{
    ...
    public double calcularSueldo(){
        if(this.horasTrabajadas <= 40){
            return this.sueldo = this.horasTrabajadas * this.precioNormal;
        }else{
            this.sueldo = (this.horasTrabajadas - 40) * this.precioExtra; 
            return this.sueldo += 40 * this.precioNormal;
    ...
    public String toString() {
        return "\nJefe: " + jefe +
               ...
               "\nPrecio por Horas Extra: " + precioExtra + super.toString();
    }
